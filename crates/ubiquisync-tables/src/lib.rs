...
//! by a small [op vocabulary](crate::op), and materialized to SQL through a
//! backend [`SqlDialect`](crate::dialect::SqlDialect). The storage-agnostic log
//! engine and clock live in [`ubiquisync-core`](ubiquisync_core); SQL backends
//! live in companion crates such as `ubiquisync-sqlite`.
