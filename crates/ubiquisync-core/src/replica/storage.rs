...
//     async fn commit_batch(&self, batch: Self::Batch) -> Result<(), Self::Error>;

//     async fn get_peer_init(&self, peer_id: &PeerId) -> Result<InitEntry, Self::Error>;
// }
